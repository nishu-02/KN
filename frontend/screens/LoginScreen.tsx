...
import { getReports, Report } from '../appwrite/service';
...
const styles = StyleSheet.create({
  ...
  orText: { color: 'rgba(255,255,255,0.6)', fontSize: 14, marginBottom: 16 },
  socialButtonsContainer: { flexDirection: 'row', justifyContent: 'center', gap: 16 },
  socialButton: {
    width: 50,
    height: 50,
    borderRadius: 25,
